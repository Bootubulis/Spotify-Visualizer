...
//APIs :)
const API_KEY = "BQA6rc1qoCkBJAuimNhWLXn9RQOu1HI4UnsYQM8At4AylpK1N_p_eKd1Qn1eW2v0P2C84mVghB7XIdsVStZ6Rabc8SCBcUkdHRXro28IetbAXv_ZtLkp5ghWUmdm7wh27cpsdbQmBUU"

function showForm(){ //displays search entry bar
    ...
    <form id="artist-search-form">
        ...
        <input type="text" name="artist" id="artist-input" placeholder="Ken Carson">
